...
def generate_pdf(results, candidate_name="Your Name / Org", logo_path=None):
    ...
    # SHAP / Importance (only if provided)
    ...
    # Footer
    story.append(Paragraph("<i>Thresholds: Low < 55%, Medium 55–75%, High > 75%</i>", styles["Italic"]))
    story.append(Spacer(1, 6))
...
# These thresholds are shifted up for demo purposes so we can clearly see Low / Medium / High spread.
